...
addNetwork({
  ...
  xpubkey: 0x0488b21e,
  xprivkey: 0x0488ade4,
  networkMagic: 0x81c384ce,
  port: 9421,
  dnsSeeds: [
    'seed.alohacoin.nationofhawaii.info',
    'seed2.alohacoin.nationofhawaii.info',
    'seed.alohacoin.hekili.net'
  ]
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'tseed.alohacoin.nationofhawaii.info',
    'testnet-seed.alohacoin.nationofhawaii.info'
  ]
};
