...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  var lhd = new Date();
  lhd.setMinutes(0);
  var lastHourTimestamp = lhd.getTime();
  var timestamp = null;
  if(this.timestamp) {
    console.log("  have ts");
    ...
    console.log("  using last hr ts");
    timestamp = lastHourTimestamp/1000;
  }
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  var obj = {
    hash: this.hash,
    timestamp: this.timestamp, // Peercoin pre-v0.7
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  this.timestamp = transaction.timestamp; // Peercoin pre-v0.7
